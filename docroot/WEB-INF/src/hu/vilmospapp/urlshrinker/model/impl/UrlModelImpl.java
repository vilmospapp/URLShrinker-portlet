...
/**
 * The base model implementation for the Url service. Represents a row in the &quot;Url&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class UrlModelImpl extends BaseModelImpl<Url> implements UrlModel {
	...
	public static final String TABLE_SQL_CREATE = "create table Url (uuid_ VARCHAR(75) null,urlId LONG not null primary key,userId LONG,companyId LONG,groupId LONG,hash VARCHAR(75) null,originalUrl VARCHAR(75) null,privateUrl BOOLEAN,protectedUrl BOOLEAN,password_ VARCHAR(75) null,createdDate DATE null,modifiedDate DATE null,archived BOOLEAN,customUrl BOOLEAN,qrcode BOOLEAN,statistics BOOLEAN)";
	public static final String TABLE_SQL_DROP = "drop table Url";
	...
	public static long HASH_COLUMN_BITMASK = 8L;
	public static long PRIVATEURL_COLUMN_BITMASK = 16L;
	public static long PROTECTEDURL_COLUMN_BITMASK = 32L;
