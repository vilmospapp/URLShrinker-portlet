 ...
 * @author Vilmos Papp
 */
public class UrlLocalServiceClp implements UrlLocalService {
	public UrlLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public hu.vilmospapp.urlshrinker.model.Url addUrl(
		...
		return (hu.vilmospapp.urlshrinker.model.Url)ClpSerializer.translateOutput(returnObj);
	}
	...
	public hu.vilmospapp.urlshrinker.model.Url createUrl(long urlId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { urlId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public hu.vilmospapp.urlshrinker.model.Url deleteUrl(long urlId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { urlId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public hu.vilmospapp.urlshrinker.model.Url fetchUrl(long urlId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { urlId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public hu.vilmospapp.urlshrinker.model.Url getUrl(long urlId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { urlId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public hu.vilmospapp.urlshrinker.model.Url updateUrl(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName16,
					...
					new Object[] { ClpSerializer.translateInput(url), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
